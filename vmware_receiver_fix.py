...
class VMwareReceiver:
    ...
    def connect_arduino(self) -> bool:
        ...
        try:
            ...
            if "Access is denied" in str(e):
                ...
                print(f"[ARDUINO] ⚠ Assuming Arduino is already connected and continuing...")
    ...
    def send_key_to_arduino(self, key_name: str, action: str) -> bool:
        ...
        try:
            ...
            if hasattr(self.serial, '__class__') and self.serial.__class__.__name__ == 'DummySerial':
                if self.enable_logging:
    ...
    def start_server(self):
        ...
        try:
            ...
            print(f"[STATUS] Arduino: {'CONNECTED' if self.is_serial_connected() else 'DISCONNECTED'}")
    ...
    def stop(self):
        ...
        if self.serial and self.is_serial_connected():
            if not (hasattr(self.serial, '__class__') and self.serial.__class__.__name__ == 'DummySerial'):
