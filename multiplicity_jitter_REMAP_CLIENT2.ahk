; ═══════════════════════════════════════════════════════════
; MULTIPLICITY JITTER - REMAP VERSION - CLIENT 2 (MEDIUM)
; ═══════════════════════════════════════════════════════════
...
; ⚙️ CLIENT 2 CONFIGURATION (MEDIUM)
global MinJitter := 60
...
MsgBox, 
(
✅ CLIENT 2 - MEDIUM JITTER (REMAP VERSION)
...
; Exit
^+q::
    MsgBox, Exiting CLIENT 2 Jitter (Remap)...
    ExitApp
    return
