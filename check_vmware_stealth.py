...
class VMwareStealthChecker:
    ...
    VMWARE_PROCESSES = [
        ...
        'vmwaretools.exe', 'vmtoolsd.exe', 'vmusrvc.exe'
    ]
    ...
    VMWARE_SERVICES = [
        'vmware', 'vmci', 'vmhgfs', 'vmmouse', 'vmrawdsk',
        'vmwaretray', 'vmwareuser', 'vmwareauthd'
    ]
    
    # VMware device drivers
    VMWARE_DRIVERS = [
        'vmware', 'vmci', 'vmhgfs', 'vmmouse', 'vmrawdsk',
        'vmware_svga', 'vmware_scsi', 'vmware_ide'
    ]
    ...
    def check_vmware_processes(self) -> List[Dict]:
        ...
        try:
            ...
            self.warnings.append({
                'type': 'check_error',
                'message': f'Không thể check processes: {e}'
            })
    ...
    def check_vmware_services(self) -> List[Dict]:
        ...
        try:
            ...
            self.warnings.append({
                'type': 'check_error',
                'message': f'Không thể check services: {e}'
            })
