...
def find_arduino_core_files():
    ...
    for base_path in possible_paths:
        ...
        if os.path.exists(expanded):
            ...
            usbcore_pattern = os.path.join(expanded, "*", "cores", "arduino", "USBCore.cpp")
    ...
    if usbcore_paths:
        ...
        print("  → Tìm dòng: STRING_PRODUCT, STRING_MANUFACTURER, STRING_SERIAL_PLACEHOLDER")
    ...
    print("   - Hoặc: C:\\Users\\<YOUR_USER>\\AppData\\Local\\Arduino15\\packages\\arduino\\hardware\\avr\\")
