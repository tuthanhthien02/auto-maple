...
ANTI_DETECT_CONFIG = {
    ...
    # Process Stealth
    "process_stealth": {
        "enabled": True,  # ENABLED - Process stealth features (hide console, memory obfuscation, process monitoring)
        "hide_console": True,
    ...
    "routine_randomization": {
        ...
        "movement": {
            ...
            "observability": {"log_every_loops": 10},
        },
        "dynamic_paths": {
            "enabled": False,
            "path_count": 4,
...
def is_feature_enabled(feature_path):
    """Check if a specific feature is enabled (with optional override from bot_config).
    ...
    return _cfg if isinstance(_cfg, bool) else False
