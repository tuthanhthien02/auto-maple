...
class DeviceStealth:
    ...
    def get_raw_input_devices(self) -> List[Dict]:
        ...
        try:
            ...
            result = user32.GetRawInputDeviceList(
                None, ctypes.byref(device_count), ctypes.sizeof(RAWINPUTDEVICELIST)
            )
    ...
    def spoof_device_properties(
        self, device_handle: wintypes.HANDLE, spoofed_name: str = "USB Keyboard"
    ) -> bool:
        """
