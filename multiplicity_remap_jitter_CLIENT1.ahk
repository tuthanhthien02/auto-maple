; ═══════════════════════════════════════════════════════════
; CLIENT 1 - Fast Player (No Remap)
; ═══════════════════════════════════════════════════════════
; Jitter: 30-80ms (fastest)
; Remap: None (keeps original keys)
; ═══════════════════════════════════════════════════════════
...
; ════════════════════════════════════════════════════════════
; 🔄 CLIENT 1 KEY REMAPPING - NO REMAP (Default Keys)
; ════════════════════════════════════════════════════════════
global KeyRemap := {}

; No remaps - Client 1 uses original keys
; You can add remaps here if needed:
; KeyRemap["q"] := "o"
